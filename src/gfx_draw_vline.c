...
void gfx_draw_vline(int x, int y, int height, uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha)
{
  if(globals.opengl)
    {
#ifdef WITH_OPENGL
    ...
    vlineRGBA(gfx_game_screen(), x, y, y + height, red, green, blue, alpha);
#endif
}
